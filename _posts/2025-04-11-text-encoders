...
![]({{ site.baseurl }}/assets/images/text-encoders/contrastive-dataset-generation.png){: .responsive-image style="--img-desktop:60%; --img-mobile:90%;"}
...
![]({{ site.baseurl }}/assets/images/text-encoders/icl-based-embeddings.png){: .responsive-image style="--img-desktop:50%; --img-mobile:90%;"}
