...
![]({{ site.baseurl }}/assets/images/paperwatch-11-08-2025/gpt-5-3.png){: .responsive-image style="--img-desktop:50%; --img-mobile:80%;"}

and less inclined for deception. The latter is tested on impossible coding tasks and missing multimodal assets:

![]({{ site.baseurl }}/assets/images/paperwatch-11-08-2025/gpt-5-4.png){: .responsive-image style="--img-desktop:50%; --img-mobile:80%;"}
