...
- Switching off the layer $f_{t}$ in $h_{t+1}=h_{t}+f_{t}$ and obtaining modified $\overbar{h}_{s}$
...
$$\frac{\|\left(h_{s+1}-h_{s}\right)-\left( \overbar{h}_{s+1}- \overbar{h}_{s}\right)\right‖_{2}}{\|h_{s+1}-h_{s}\right‖_{2}}$$
...
![]({{ site.baseurl }}/assets/images/paperwatch-28.05.2025/15-image-15.png){: .responsive-image style="--img-desktop:100%; --img-mobile:90%;"}
...
![]({{ site.baseurl }}/assets/images/paperwatch-28.05.2025/17-image-17.png){: .responsive-image style="--img-desktop:100%; --img-mobile:90%;"}
...
![]({{ site.baseurl }}/assets/images/paperwatch-28.05.2025/31-image-31.png){: .responsive-image style="--img-desktop:75%; --img-mobile:90%;"}
  ...
  - **Multimodal Reasoning Rewards**: For math-related (geometry) tasks such as [GeoQA](https://arxiv.org/pdf/2105.14517) and [CLEVR](https://arxiv.org/pdf/1612.06890), it’s the same correctness and format. In addition, for caption-based tasks, **CLIP Reward** is used:                             $0.1 · CLIP(image, text)$.
