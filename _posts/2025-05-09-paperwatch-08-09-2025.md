...
![]({{ site.baseurl }}/assets/images/paperwatch-25-08-2025/zero-writer-0.png){: .responsive-image style="--img-desktop:90%; --img-mobile:100%;"}
...
![]({{ site.baseurl }}/assets/images/paperwatch-25-08-2025/zero-writer-1.png){: .responsive-image style="--img-desktop:90%; --img-mobile:100%;"}

A small human study was also in favour of the model trained with pairwise reward.

While I somewhat doubt that the authors' dataset managed to really capture the essense of creativity (because it's so hard to score and so multifaceted), the paper is interesting, and I hope to see more papers about creative writing in the future!
...
![]({{ site.baseurl }}/assets/images/paperwatch-25-08-2025/sign-rank-0.png){: .responsive-image style="--img-desktop:70%; --img-mobile:100%;"}
...
![]({{ site.baseurl }}/assets/images/paperwatch-25-08-2025/sign-rank-1.png){: .responsive-image style="--img-desktop:90%; --img-mobile:100%;"}
...
![]({{ site.baseurl }}/assets/images/paperwatch-25-08-2025/sign-rank-2.png){: .responsive-image style="--img-desktop:90%; --img-mobile:100%;"}
