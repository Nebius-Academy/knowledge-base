---
layout: post
title: "LLM evaluation, chapter 4: Model-based scoring"
categories: blog
permalink: /evaluation-4-model-based/
---
...
You can learn more about text encoders in [this long read](https://nebius-academy.github.io/knowledge-base/text-encoders/).
...
![]({{ site.baseurl }}/assets/images/evaluation/bert-score.png){: .responsive-image style="--img-desktop:80%; --img-mobile:90%;"}
...
![]({{ site.baseurl }}/assets/images/evaluation/cross-encoder.png){: .responsive-image style="--img-desktop:70%; --img-mobile:90%;"}
...
There are lots of models for sentiment analysis. Among the reliable ones is [**roberta-base-go_emotions**](https://huggingface.co/SamLowe/roberta-base-go_emotions)
...
[**roberta-hate-speech-dynabench-r4-target**](https://huggingface.co/facebook/roberta-hate-speech-dynabench-r4-target) is an example of a capable model for evaluating toxicity.
